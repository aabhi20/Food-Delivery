  ...
  return (
    <>
      <header className="flex items-center justify-between bg-[#f7f0d6] sm:hidden">
        <div className="flex items-center p-2 sm:hidden bg-[#f7f0d6]">
          <div className="w-24 h-12 border-1 border-[#FFBE0B] border-r-0 rounded-[10px] rounded-r-none">
            <img src={banner} className="w-24 h-12 " />
          </div>
          <div className="border-1 border-[#FFBE0B] hover:border-[#CC9500] p-[11px] rounded-[10px] rounded-l-none">
      ...
      <div className="hidden sm:flex text-[20px] justify-between items-center bg-[#fff9ec] shadow-[0_4px_10px_rgba(0,0,0,0.1)] p-2">
